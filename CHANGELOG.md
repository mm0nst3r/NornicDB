...
- Optional Snowball stemming for Russian and English BM25 analysis through
  ...
  queries in both BM25 engines. Original text and literal phrase matching remain unchanged.
- Analyzer identities in BM25 snapshots and build-settings fingerprints, with
  incompatible indexes rebuilt when analysis changes.
