...
var settingsRegistry = []SettingDefinition{
	...
	{Name: "db.nornic.search.rerank.truncation", EnvironmentVariable: "NORNICDB_SEARCH_RERANK_TRUNCATION", Type: "boolean", Category: "Search", Scope: ScopeDatabase, Dynamic: true, RestartLevel: RestartNone, HotReload: HotReloadSearchRebuild},
	{Name: "db.nornic.search.rerank.failure.policy", EnvironmentVariable: "NORNICDB_SEARCH_RERANK_FAILURE_POLICY", Type: "enum", ValidValues: []string{"error", "original"}, Category: "Search", Scope: ScopeDatabase, Dynamic: true, RestartLevel: RestartNone, HotReload: HotReloadSearchRebuild},
	...
	{Name: "db.nornic.embed.auto.chunking", EnvironmentVariable: "NORNICDB_EMBED_AUTO_CHUNKING", Type: "boolean", Category: "Embed worker", Scope: ScopeDatabase, RestartLevel: RestartProcess},
